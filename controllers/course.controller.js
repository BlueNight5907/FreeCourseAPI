...
import * as getId from '../utils/getIdfromAccessToken.js';
...
export const createCourse = async(req, res) => {
	...
	const _IdAccount = await getId.convertAccessTokenToId(accessToken, accessTokenSecret);

	const course = new courseModel({title:title, content:content, shortDesc:shortDesc, background:background,password:password});
